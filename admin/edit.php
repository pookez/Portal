...
if(isset($_SESSION['name'])){
	...
	if (isset($_POST['submit'])){
		...
		pilihan_c='$pilihan_c',pilihan_d='$pilihan_d',jawaban='$jawaban',publish='$publish',tipe='$tipe',materi='$materi' where id_soal='$id'");
		
		if($query){
			?><script language="javascript">document.location.href="?page=view2";</script><?php
		}else{
			echo mysql_error();
		}
    ...
    <tr>
        ...
        <td><input type="text" name="materi" value="<?php echo $row['materi'];?>" size="30"/></td>
    </tr>
    <tr>
